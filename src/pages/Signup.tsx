...
export default function Signup() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(err.message?.includes('email-already') ? 'Email already in use' : err.message || 'Signup failed')
        } finally {
            setLoading(false)
        }
    }
            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <Link to="/" className="inline-flex items-center gap-2.5 mb-4">
                        <div className="w-12 h-12 rounded-2xl gradient-primary flex items-center justify-center shadow-lg shadow-sky-500/20">
                            <BookOpen className="w-7 h-7 text-white" />
                        </div>
                    </Link>
                    <h1 className="text-2xl font-bold">Create Account</h1>
                    <p className="text-muted-foreground mt-1">Start your reading journey</p>
                </div>
                ...
                <div className="bg-card rounded-2xl border border-border p-6 shadow-sm">
                    ...
                    <p className="text-center text-sm text-muted-foreground mt-6">
                        ...
                        <Link to="/login" className="text-sky-600 dark:text-sky-400 hover:underline font-medium">Sign In</Link>
                    </p>
                </div>
            </div>
        </div>
