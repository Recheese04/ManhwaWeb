...
export default function MobileDrawer({ open, onClose }: MobileDrawerProps) {
    ...
    return (
        <>
            ...
            <div
                className={cn(
                    'fixed top-0 right-0 h-full w-72 bg-background border-l border-border z-50 transform transition-transform duration-300 flex flex-col shadow-2xl',
            ...
            >
                ...
                <div className="p-4 border-t border-border">
                    <div className="flex items-center gap-3">
                        <img
                            src="https://placehold.co/36x36/0ea5e9/ffffff?text=MF"
                            alt="Avatar"
                            className="w-9 h-9 rounded-full"
                        />
                        <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium truncate">MangaFan99</p>
                            <p className="text-xs text-muted-foreground truncate">mangafan99@example.com</p>
                        </div>
                    </div>
                </div>
            </div>
